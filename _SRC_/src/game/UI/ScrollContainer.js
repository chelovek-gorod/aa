...
import { TABLE_WIDTH } from '../scenes/results/ResultsScene'
...
export default class ScrollContainer extends Container {
    constructor(contentContainer, visibleHeight) {
        super()
        ...
        this.maskGraphics.roundRect(0, 0, TABLE_WIDTH, this.viewHeight, MASK_RADIUS)
        ...
        this.hitArea = new Rectangle(0, 0, TABLE_WIDTH, this.viewHeight)
        this.cursor = 'pointer'
        ...
        this.bgBounds = new Rectangle(-BG_PADDING, -BG_PADDING, TABLE_WIDTH + BG_PADDING * 2, this.viewHeight + BG_PADDING * 2)
    ...
    updateScrollbar() {
        ...
        const trackX = TABLE_WIDTH - SCROLL_PADDING_RIGHT - SCROLL_LINE_WIDTH
